...
## Layers 
Map does have 3 layers: 10 movies filmed in the near area in the exact year, ALL movies filmed in the exact year and the actual map.
You can choose between those right above
![alt text](https://github.com/mkruhliy/map_movies/blob/main/example1.png?raw=true)
Here how it works(10 nearest):
![alt text](https://github.com/mkruhliy/map_movies/blob/main/example2.png?raw=true)
## Markers
You can also see the title of each movie by clicking on the marker
